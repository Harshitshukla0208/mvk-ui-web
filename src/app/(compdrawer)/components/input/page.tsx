...
import InputBoxesCodes from '@/components/CodeBoxes/InputBoxesCodes'
    ...
    return (
        <div className='mt-16 w-full px-4'>
            ...
            <div className='flex gap-2 mt-5'>
                ...
                <p className='component-preview-title'>Input boxes: the blank spaces where you type stuff.</p>
            </div>
            <div className='flex gap-2 mt-5'>
                <p className='opacity-40 hover:opacity-60'>#</p>
